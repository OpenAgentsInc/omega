...
fn update_command_palette_filter(cx: &mut App) {
    ...
    CommandPaletteFilter::update_global(cx, |filter, _| {
        ...
        if disable_ai {
            ...
            filter.hide_action_types(&[TypeId::of::<zed_actions::OpenOmegaPredictOnboarding>()]);
        } else {
            if agent_enabled {
            ...
            filter.show_action_types(&[TypeId::of::<zed_actions::OpenOmegaPredictOnboarding>()]);
