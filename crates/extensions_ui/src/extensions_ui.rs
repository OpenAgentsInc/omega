...
use omega_actions::ExtensionCategoryFilter;
...
pub fn init(cx: &mut App) {
    ...
    cx.observe_new(move |workspace: &mut Workspace, window, _cx| {
        ...
        workspace
            .register_action(
                move |workspace, action: &omega_actions::Extensions, window, cx| {
    ...
    fn on_extension_installed(
            ...
            workspace
                .update(cx, |_workspace, cx| {
                    window.dispatch_action(
                        omega_actions::theme_selector::Toggle {
        ...
        if !icon_themes.is_empty() {
            workspace
                .update(cx, |_workspace, cx| {
                    window.dispatch_action(
                        omega_actions::icon_theme_selector::Toggle {
                            ...
                            .when(!is_compatible, |upgrade_button| {
                                upgrade_button.disabled(true).tooltip({
                                    ...
                                    move |_, cx| {
                                        Tooltip::simple(
                                            format!(
                                                "v{version} is not compatible with this version of Omega.",
                                            ),
                                             cx,
                                        )
                                    }
