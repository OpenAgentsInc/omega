...
pub struct LanguageConfig {
    ...
    /// Used when a kernel's `language` field differs from Omega's language name.
    ...
    /// By default, Omega treats as paragraph and comment prefixes as boundaries.
    ...
    /// A list of characters that Omega should treat as word characters for the
    ...
    /// A list of characters that Omega should treat as word characters for completion queries.
    #[serde(default)]
    pub completion_query_characters: HashSet<char>,
    /// A list of characters that Omega should treat as word characters for linked edit operations.
    #[serde(default)]
