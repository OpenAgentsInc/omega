    ...
    fn apply_unchecked(
        ...
        match transition {
            ...
            ProjectionTransition::CompleteSurfaceLoad {
                ...
                thread.artifact_revision =
                    next_revision("artifact revision", thread.artifact_revision)?;
                thread.event_revision = next_revision("event revision", thread.event_revision)?;
                Ok(TransitionEffect::Applied)
            }
