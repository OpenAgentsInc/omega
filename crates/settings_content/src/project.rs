...
pub struct ProjectSettingsContent {
    ...
    /// Whether to disable all AI features in Omega.
    ///
    /// Default: false
...
pub struct LspSettings {
    ...
    /// this setting can be used to enable or disable them in Omega.
    /// Default: true
...
pub struct GitSettings {
    ...
    /// `"../worktrees"` and a project at `~/code/omega`, worktrees are
    /// created under `~/code/worktrees/omega/`.
    ///
...
pub struct DiagnosticsSettingsContent {
    ...
    /// Settings for using LSP pull diagnostics mechanism in Omega.
...
pub struct NodeBinarySettings {
    ...
    pub path: Option<String>,
    /// The path to the npm binary Omega should use (defaults to `.path/../npm`).
    pub npm_path: Option<String>,
    /// If enabled, Omega will download its own copy of Node.
    pub ignore_system_version: Option<bool>,
}
