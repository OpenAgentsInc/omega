...
AppPublisher=OpenAgents
AppPublisherURL=https://www.openagents.com/
AppSupportURL=https://www.openagents.com/
AppUpdatesURL=https://www.openagents.com/
...
[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl,{#ResourcesDir}\messages\en.isl"; LicenseFile: "script\terms\open-source-notices.rtf"
Name: "simplifiedChinese"; MessagesFile: "{#ResourcesDir}\messages\Default.zh-cn.isl,{#ResourcesDir}\messages\zh-cn.isl"; LicenseFile: "script\terms\open-source-notices.rtf"
...
[Files]
Source: "{#ResourcesDir}\Omega.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
...
; URI Scheme
Root: HKCU; Subkey: "Software\Classes\{#AppScheme}"; ValueType: "string"; ValueData: "URL:{#AppScheme} Protocol"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\{#AppScheme}"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCU; Subkey: "Software\Classes\{#AppScheme}\DefaultIcon"; ValueType: "string"; ValueData: "{app}\{#AppExeName}.exe,1"
Root: HKCU; Subkey: "Software\Classes\{#AppScheme}\shell\open\command"; ValueType: "string"; ValueData: """{app}\{#AppExeName}.exe"" ""%1"""
