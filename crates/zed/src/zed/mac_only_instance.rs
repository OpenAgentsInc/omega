...
fn address() -> SocketAddr {
    ...
    let port = match *release_channel::RELEASE_CHANNEL {
        ...
        ReleaseChannel::Preview => 44737 + USER_BLOCK,
        ReleaseChannel::Stable => 44737 + (2 * USER_BLOCK),
        ReleaseChannel::Nightly => 44737 + (3 * USER_BLOCK),
    };
...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Omega Dev Instance Running",
        ReleaseChannel::Nightly => "Omega Nightly Instance Running",
        ReleaseChannel::Preview => "Omega RC Instance Running",
        ReleaseChannel::Stable => "Omega Instance Running",
    }
}
