...
`v0.2.0-rc30`. It replaces inherited Zed release automation for this candidate.
...
publication use the rc30 names below.

## Goal

Produce a signed macOS arm64 candidate:

- Artifact: `Omega-v0.2.0-rc30-macos-arm64.dmg`
...
```text
target/omega-rc/Omega-v0.2.0-rc30-macos-arm64.dmg
...
4. Create a GitHub **prerelease** tagged `v0.2.0-rc30` on
   `OpenAgentsInc/omega`.
