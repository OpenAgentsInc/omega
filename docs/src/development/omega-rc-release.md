...
`v0.2.0-rc23`. It replaces inherited Zed release automation for this candidate.
...
publication use the rc23 names below.

## Goal

Produce a signed macOS arm64 candidate:

- Artifact: `Omega-v0.2.0-rc23-macos-arm64.dmg`
...
```text
target/omega-rc/Omega-v0.2.0-rc23-macos-arm64.dmg
target/omega-rc/omega-v0.2.0-rc23-macos-arm64.release.json
```
...
4. Create a GitHub **prerelease** tagged `v0.2.0-rc23` on
   `OpenAgentsInc/omega`.
