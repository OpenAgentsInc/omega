...
Configure language servers in Settings ({#kb omega::OpenSettings}) under Languages > R, or add to your settings file:
...
If you use the `"r_language_server"` from `REditorSupport/languageserver`, but would still like to use Air for formatting, configure in Settings ({#kb omega::OpenSettings}) under Languages > R, or add to your settings file:
