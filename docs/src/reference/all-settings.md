...
- Description: Controls whether Omega or the window manager or compositor draws window decorations.
- Setting: `window_decorations`
- Default: `"client"`

**Options**

1. To have Omega draw its own window decorations, use `"client"`:
...
> Note: This setting only affects Linux. GNOME Wayland does not support server-side decorations. Changes only apply to newly created windows. Restart Omega to apply the setting to all windows.
